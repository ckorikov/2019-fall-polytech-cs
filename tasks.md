...
## 6. АТД: дерево
### 1. Деревья поиска
1. **(10 баллов, Microsoft)** Напишите функцию, которая восстанавливает дерево по результатам прохода preorder и inorder проходов. Напишите тесты с помощью модуля `unittest`.  <details><summary>ℹ️ Подсказка</summary>Например, для таких входных данных: 
```
...
2. **(10 баллов, Microsoft)** Напишите функцию, которая возвращает колличество поддеревьев с одинаковыми значениями в узлах. <details><summary>ℹ️ Подсказка</summary>Например, для такого дерева: 
```
   0
  / \
 1   0
